...
CREATE TABLE `deprecationerrors` (
  ...
  `traces` mediumtext DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `sections` (
  ...
  `defaultPlacement` enum('beginning','end') NOT NULL DEFAULT 'end',
  `previewTargets` mediumtext DEFAULT NULL,
  `dateCreated` datetime NOT NULL,
  `dateUpdated` datetime NOT NULL,
  `dateDeleted` datetime DEFAULT NULL,
  `uid` char(36) NOT NULL DEFAULT '0',
...
-- Dump completed on 2023-10-03 10:53:30
-- MariaDB dump 10.19  Distrib 10.6.14-MariaDB, for Linux (aarch64)
--
-- Host: mysql    Database: project
-- ------------------------------------------------------
...
set autocommit=0;
INSERT INTO `info` VALUES (1,'5.0.0-alpha','5.0.0.8',0,'zvsvabyzceym','3@nnxainrdze','2023-02-02 05:28:23','2023-10-03 10:53:20','876de66d-7fde-40c5-b8b8-c4713c00d927');
...
set autocommit=0;
INSERT INTO `plugins` VALUES (1,'ckeditor','4.0.x-dev','3.0.0.0','2023-10-03 10:50:37','2023-10-03 10:50:37','2023-10-03 10:50:37','212634d2-d8bd-47b7-a3bf-be7e4947ea31');
...
set autocommit=0;
INSERT INTO `users` VALUES (1,NULL,1,0,0,0,1,'admin',NULL,NULL,NULL,'info@nystudio107.com','$2y$13$crqJ.kzM.kBs.WsWGUxT9uUdR4Imi./d9prVKVya/MkWu/Bd/8.Ga','2023-10-03 10:42:50',NULL,NULL,NULL,'2023-10-03 10:35:41',NULL,1,NULL,NULL,NULL,0,'2023-02-02 05:28:24','2023-02-02 05:28:24','2023-10-03 10:42:50');
...
set autocommit=0;
INSERT INTO `volumes` VALUES (1,1,'Site','site','site',NULL,'','','site',NULL,1,'2023-02-08 03:29:07','2023-02-08 03:29:07','2023-02-08 03:42:36','f1e4b2eb-dc38-4ad8-84ad-21f3b3d77b5c'),(2,2,'Site','site','site',NULL,'','','site',NULL,2,'2023-02-08 03:43:40','2023-02-08 03:43:40','2023-02-08 05:14:43','d5560f04-30c7-44c4-bb4a-e0818cae1130'),(3,3,'Site','site','site',NULL,'','','site',NULL,3,'2023-02-08 06:11:59','2023-02-08 06:11:59','2023-02-08 14:19:31','4e23983a-4146-4e63-9e2b-ee3b32b07f12');
